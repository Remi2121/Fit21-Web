...
import "./exercise.css";
import Login from "../components/login/login"; // 👈 added for popup
...
const ExerciseSelect = () => {
  ...
  const exercises = [
    ...
    { name: "Yoga", icon: <FaPrayingHands className="ex-icon" aria-hidden />, path: "/yoga" }, // fixed path
    { name: "Quiz", icon: <FaClipboardList className="ex-icon" aria-hidden />, path: "/quizstart" },
  ];

  // 👇 handle click for login check
    ...
    <>
      ...
      <div className="exercise-container">
        <div className="glass-card">
          ...
          {/* ⚠️ Message shown if not logged in */}
          ...
          <div className="exercise-list">
            {exercises.map((item, i) => (
              <Link
                ...
                onClick={(e) => handleExerciseClick(item.path, e)} // 👈 added
              >
